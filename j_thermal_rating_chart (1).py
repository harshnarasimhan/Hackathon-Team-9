...
def _find_participant_kit_dir():
    """Locate the participant-kit root (identified by gridkit.py sitting
    in it), whether this script is at participant-kit/examples/ (the
    layout this file originally assumed) or flattened at the repo root
    (the layout actually committed on this branch - see Track A audit
    F-06). This script doesn't import gridkit itself, but it needs the
    same root to find figures/ and the other scripts' output CSVs.
    """
...
ROOT = _find_participant_kit_dir()
